                            ...
                            <div className={`leader-${index}`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        ...
                                        stroke={getTrophyColor(index)} strokeWidth="1.5"/>
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke={getTrophyColor(index)} strokeWidth="1.5"/>
                                    <path d="M12 16V19" stroke={getTrophyColor(index)} strokeWidth="1.5"
                                          strokeLinecap="round"/>
                                    <path
                                        ...
                                        stroke={getTrophyColor(index)} strokeWidth="1.5" strokeLinecap="round"
                                        strokeLinejoin="round"/>
                                    <path d="M18 22H6" stroke={getTrophyColor(index)} strokeWidth="1.5"
                                          strokeLinecap="round"/>
                                </svg>
                            </div>
                        )}
